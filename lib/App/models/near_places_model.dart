...
NearPlaceModel nearPlaceModelFromJson(String str) => NearPlaceModel.fromJson(json.decode(str));

String nearPlaceModelToJson(NearPlaceModel data) => json.encode(data.toJson());
...
class NearPlaceModel {
  ...
  NearPlaceModel.fromJson(Map<String, dynamic> json) {
    if (json['html_attributions'] != null) {
      htmlAttributions = <Null>[];
      json['html_attributions'].forEach((v) {
        htmlAttributions!.add(htmlAttributions);
      });
    }
