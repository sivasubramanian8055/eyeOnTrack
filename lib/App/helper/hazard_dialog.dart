      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            myText(title: data['message'].toString(),fontWeight: FontWeight.bold,fontSize: 15),
          ...
          if(data['message'].toString()=='Construction Work Ahead'||data['message'].toString()=='Pedestrian Crossing Ahead')
            Image.asset('assets/constructionIMG.jpeg',height: 200,width: 200,)
            else
            Image.asset("assets/alert.png",height: 60,width: 60,),
      ...
      children: [
        Container(
          ...
          child:   Column( children: [
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: myText(title: 'Track',fontSize: 14,fontWeight: FontWeight.w500,color: Colors.white),
                )),
            ...
            const SizedBox(height: 8,),
            Image.asset(/*assetImgUrl(data['title'].toString())*/"assets/coin.png",height: 60,width: 60,),
            const SizedBox(height: 8,),

            myText(title:"Hey! you just followed the construction safety sign. You have Earned 5 points.",fontWeight: FontWeight.w500,fontSize: 14),
            const SizedBox(height: 5,)
          ],),
        )
      ],
